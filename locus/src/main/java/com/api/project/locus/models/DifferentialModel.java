...
public class DifferentialModel implements Serializable{
	...
	public String toString() {
		return "DifferentialModel [id=" + id + ", nome=" + nome + ", descricao=" + descricao + ", dataInclusao="
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DifferentialModel other = (DifferentialModel) obj;
